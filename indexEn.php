...
<body>
      ...
      <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
        ...
        <div class="offcanvas-body position-relative">
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item" onclick="navBarItemClick()">
              <a class="nav-link active" aria-current="page" href="#chiSiamo">About us</a>
            </li>
            <li class="nav-item" onclick="navBarItemClick()">
              <a class="nav-link active" aria-current="page" href="#settori">Sectors</a>
            </li>
            <li class="nav-item" onclick="navBarItemClick()">
              <a class="nav-link active" aria-current="page" href="#collaborazioni">Collaborations</a>
            </li>
            <li class="nav-item" onclick="navBarItemClick()">
              <a class="nav-link active" aria-current="page" href="#doveSiamo">Where we are</a>
            </li>
            <li class="nav-item" onclick="navBarItemClick()">
              <a class="nav-link active" aria-current="page" href="#contattaci">Contact us</a>
            </li>
            <!-- change language to italian button -->
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="index.php">
                <img src="assets\img\usa.png" alt="Italian" height="20" class="d-inline-block align-text-top">
              </a>
            </li>
          </ul>
          <a href="http://app.3em.it/core/login.php" class="btn-outline mt-5 mx-auto col-12 col-md-5">Reserved area</a>
          <a href="workwithus.php"
            ...
            style="bottom: 50px;">Work with us</a>
        </div>
      </div>
    </div>
  </nav>
  ...
  <nav class="navbar navbar-light fixed-top navbarXL px-3 justify-content-between" oncontextmenu="return false">
    ...
    <div class="navbar-body d-flex flex-row">
      <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 d-flex flex-row">
        ...
        <li class="nav-item mx-3">
          <a class="nav-link active" aria-current="page" href="workwithus.php">Work with us</a>
        </li>
        <li class="nav-item mx-3">
          <a class="nav-link active" aria-current="page" href="index.php">
            <img src="assets\img\usa.png" alt="Italian" height="20" class="d-inline-block align-text-top">
    ...
    <a href="http://app.3em.it/core/login.php" class="btn-outline">Reserved Area</a>
  </nav>

  <section class="container-fluid flex-column" id="home">
    <div class="row mx-4">
      <img src="assets/img/bianco.svg" alt="3EM Engineering" height="150%">
      <span class="col-12 home-subtitles mt-3"></span>
    </div>
    <div class="row home-button-row">
      <div class="col-12">
        <a href="#chiSiamo">
  ...
  <section class="container px-4 px-md-auto" id="chiSiamo">
    ...
    <div class="row mt-4">
    <div class="col-12">For over 30 years, <b>3EM Engineering</b> has been active in the industrial sector of mechanical and electrical assembly and maintenance, machinery engineering, and systems in the Automotive, Oil & Gas, and Steel industries. Additionally, <b>3EM Engineering</b> offers itself as a partner for the development of complete and professional solutions in the field of Information Technology. We provide worldwide support to all our clients, offering on-site and remote assistance.
      </div>
    </div>
    <div class="row align-items-center justify-content-center mt-5">
    <a href="#settori" class="btn-outline mx-auto col-8 col-md-5">Discover our services</a>
    </div>
    ...
    <div class="col-12 mt-5"><b>3EM Engineering</b> is a strategic partner for advanced technological improvements to innovate
        plants and
        processes, ensuring
        timely project delivery and total cost certainty.</div>
    <div class="row">
      ...
      <div class="col-12 col-md-8 col-xl-4 card-settori">
        <div class="card-body bg-black">
          <div class="card-text">
            ...
            <span>
                3EM Engineering provides automation services, as well as engineering, for a wide range of industrial plants.
                Automation and plant are designed and qualitatively tested at our production centers. <div class="d-flex flex-wrap">
      ...
      <div class="col-12 col-md-8 col-xl-4 card-settori card-erection position-relative">
        ...
        <div class="card-body bg-black">
          <div class="card-text">
            ...
            <span>
              3EM Engineering operates worldwide offering a complete range of services related to MEIP (Mechanical, Electrical, Instrumentation, Piping) installations for industrial plants.
      ...
      <div class="col-12 col-md-8 col-xl-4 card-settori">
        <div class="card-body bg-black">
          <div class="card-text">
            <h2>IT Services</h2>
            <span>
                3EM Engineering aims to be a partner for the development and testing of complete solutions and professional services in the field of Information Technology, offering a multidisciplinary approach and local presence. <div
  ...
  <section class="container px-4 px-md-auto" id="doveSiamo">
    ...
    <div class="col-12 section-title">Where to find us</div>
    </div>
  ...
  <section class="container px-4 px-md-auto" id="contattaci">
    <div class="row align-items-center justify-content-start">
      <div class="col-12 col-md-3 section-title">Contact us</div>
      <a href="workwithus.php"
        class="shadow-sm rounded-pill py-2 text-center col-5 col-md-2 mx-0 ms-3 mt-4 mt-md-0 text-light button bg-primary">Work with us</a>
    </div>
        ...
        <form id="form" class="needs-validation">
          ...
          <div class="form-floating">
            <input type="password" class="form-control" id="nomeInput" placeholder="Nome e Cognome" name="nome"
              required>
            <label for="nomeInput">First name and last name</label>
          </div>
          <div class="row mt-5 mx-1">
            <label for="exampleFormControlTextarea1" class="form-label">Message</label>
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" required></textarea>
          </div>
          <button type="submit" class="btn-outline mx-auto col-8 col-md-5 btnForm">Send</button>
        </form>
      </div>
  </section>
