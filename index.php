...
<body class="overflow-x-hidden">
  ...
  <section class="container-fluid flex-column" id="home">
    <div class="mx-4 svg_cont">
      <div class="svg-wrapper svg-1">
        <svg id="logo_svg_top" viewBox="0 0 1135 366" fill="none" xmlns="http://www.w3.org/2000/svg"
          style="z-index: 99">
          <path d="M361.636 0.0932617V365.58H0V264.67H240.684V233.288H0V132.377H240.684V101.004H0V0.0932617H361.636Z"
            fill="#fff" />
          <path
            d="M386.318 365.58V0.0927734H747.954V101.003H507.271V132.377H747.954V233.287H507.271V264.669H747.954V365.58H386.318Z"
            fill="#fff" />
          <path d="M772.143 0H1135V364.257H1034.82V121.829H1003.66V364.257H903.484V121.829H872.327V364.257H772.143V0Z"
            fill="#fff" />
        </svg>
      </div>
      <div class="svg-wrapper svg-2">
        <svg id="logo_svg_bottom" viewBox="0 5 1008 90" fill="none" xmlns="http://www.w3.org/2000/svg"
          style="z-index: 99">
          <path
          ...
          <path
            ...
            fill="#fff" />
          <path d="M315.223 101.315V2.62012H336.743V101.315H315.223Z" fill="#fff" />
          <path
          ...
          <path
            ...
            fill="#fff" />
          <path d="M761.57 101.315V2.62012H783.124V101.315H761.57Z" fill="#fff" />
          <path
        ...
        <svg id="svg_red_dot" viewBox="-20 5 130 90" fill="none" xmlns="http://www.w3.org/2000/svg" style="z-index: 99">
          <path d="M100.992 0.547852H0.958008V101.307H100.992V0.547852Z" fill="#FB2601" />
        </svg>
      </div>
    </div>
  ...
  <section class="container px-4 px-md-auto" id="chiSiamo">
    <div data-aossssss="fade-left">
      ...
      <div class="row mt-4">
        <div class="col-12">
          Da oltre 30 anni <b>3EM Engineering</b> è attiva nel settore
          industriale del montaggio e manutenzione meccanica ed elettrica,
          ingegneria di macchinari e sistemi nel settore Automotive, Oil & Gas
          e Steel. Inoltre, <b>3EM Engineering</b>
          si propone come partner per lo sviluppo di soluzioni complete e
          professionali nel campo dell'Information Technology.Supporto a
          livello mondiale per tutti i nostri clienti fornendo assistenza on
          site e da remoto.
        </div>
      </div>
    </div>
    <div data-aossssss="fade-right">
      ...
      <div class="col-12 mt-5">
        <b>3EM Engineering</b> è un partner strategico per miglioramenti
        tecnologici avanzati per innovare impianti e processi, garantendo la
        consegna puntuale dei progetti e la totale certezza dei costi di
        investimento.
      </div>
    </div>
          ...
          <div
            ...
            <div class="position-relative">
              ...
              <a href="https://www.linkedin.com/in/marco-esposito-16397713/" class="image-icon"><i
                  class="fa-brands fa-linkedin" style="scale: 0.6"></i></a>
            </div>
        ...
        <div class="col-12 row justify-content-center">
          <div
            ...
            <div class="position-relative">
              ...
              <a href="https://www.linkedin.com/in/ingantonioleone/" class="image-icon"><i class="fa-brands fa-linkedin"
                  style="scale: 0.6"></i></a>
            </div>
            <div class="d-flex flex-column">
        ...
        <div class="col-12 row justify-content-center">
          <div
            ...
            <div class="position-relative">
              ...
              <a href="" class="image-icon"><i class="fa-brands fa-linkedin" style="scale: 0.6"></i></a>
            </div>
            <div class="d-flex flex-column">
  ...
  <section class="container px-4 px-md-auto" id="settori">
    ...
    <div class="row justify-content-start justify-content-md-center">
      <div class="col-12 col-md-8 col-xl-4 card-settori" data-aossssss="fade-up-right">
        <div class="card-body bg-black">
          <div class="card-text">
            ...
            <span>
              3EM Engineering fornisce servizi di automazione, nonché
              ingegneria, per una vasta gamma di impianti industriali.
              L'automazione e l'impianto vengono progettati e testati
              qualitativamente presso i nostri centri produttivi.
      ...
      <div class="col-12 col-md-8 col-xl-4 card-settori card-erection position-relative" data-aossssss="fade-up">
        ...
        <div class="card-body bg-black">
          <div class="card-text">
            ...
            <span>
              3EM Engineering opera in tutto il mondo offrendo una gamma
              completa di servizi legati al MEIP (Meccanici, Elettrici,
              Strumentali, Piping) installazioni per impianti industriali.
              <div class="d-flex flex-wrap">
                <div class="card-icon">
      ...
      <div class="col-12 col-md-8 col-xl-4 card-settori" data-aossssss="fade-up-left">
        <div class="card-body bg-black">
          <div class="card-text">
            <h2>IT Services</h2>
            <span>
              3EM Engineering si propone come partner per lo sviluppo e
              testing di soluzioni complete e servizi professionali nel campo
              dell'Information Technology proponendo un’offerta
              multidisciplinare e presenza sul territorio.
              <div class="d-flex flex-wrap">
  ...
  <section class="container px-4 px-md-auto mt-5" id="collaborazioni" data-aossssss="fade-up">
  ...
  <section class="container px-4 px-md-auto mt-5" id="sponsor" data-aossssss="fade-up">
    ...
    <div class="row unina_section align-items-center justify-content-center justify-content-md-between">
      <blockquote class="instagram-media col-6 col-md-4 m-0" style="height: 50vh; opacity: 90%"
        ...
        <div style="padding: 16px">
          <a href="https://www.instagram.com/p/C3qB8tFqCxc/?utm_source=ig_embed&amp;utm_campaign=loading" style="
                background: #ffffff;
                line-height: 0;
                padding: 0 0;
                text-align: center;
          ...
          <p style="
            ...
            <a href="https://www.instagram.com/p/C3qB8tFqCxc/?utm_source=ig_embed&amp;utm_campaign=loading" style="
                  ...
                  line-height: 17px;
                  text-decoration: none;
                " target="_blank">Un post condiviso da TRE EMME ENGINEERING (@3emengineering)</a>
          </p>
        </div>
      </blockquote>
      <script async src="//www.instagram.com/embed.js"></script>
      <blockquote class="instagram-media col-6 col-md-4 m-0" style="height: 50vh; opacity: 0"
        ...
        data-instgrm-version="14" style="
          ...
          ">
        <div style="padding: 16px">
          <a href="https://www.instagram.com/p/CpKXvhUKVNk/?utm_source=ig_embed&amp;utm_campaign=loading" style="
                background: #ffffff;
                line-height: 0;
                padding: 0 0;
                text-align: center;
          ...
          <p style="
            ...
            <a href="https://www.instagram.com/p/CpKXvhUKVNk/?utm_source=ig_embed&amp;utm_campaign=loading" style="
                  ...
                  line-height: 17px;
                  text-decoration: none;
                " target="_blank">A post shared by TRE EMME ENGINEERING (@3emengineering)</a>
          </p>
        </div>
      </blockquote>
      <script async src="//www.instagram.com/embed.js"></script>
      <blockquote class="instagram-media col-6 col-md-4 m-0" style="height: 50vh; opacity: 90%"
        ...
        data-instgrm-version="14" style="
          ...
          ">
        <div style="padding: 16px">
          <a href="https://www.instagram.com/p/CtgYezZroSD/?utm_source=ig_embed&amp;utm_campaign=loading" style="
                background: #ffffff;
                line-height: 0;
                padding: 0 0;
                text-align: center;
          ...
          <p style="
            ...
            <a href="https://www.instagram.com/p/CtgYezZroSD/?utm_source=ig_embed&amp;utm_campaign=loading" style="
                  ...
                  line-height: 17px;
                  text-decoration: none;
                " target="_blank">A post shared by UniNa Corse (@uninacorseteam)</a>
          </p>
        </div>
      </blockquote>
      <script async src="//www.instagram.com/embed.js"></script>
    ...
    <div class="row mt-2 canoa_section align-items-center justify-content-center justify-content-md-between">
      <blockquote class="instagram-media col-6 col-md-4 m-0" style="height: 50vh; opacity: 90%" data-instgrm-captioned
        ...
        data-instgrm-version="14" style="
          ...
          ">
        <div style="padding: 16px">
          <a href="https://www.instagram.com/p/C_6YRS3uGQx/?utm_source=ig_embed&amp;utm_campaign=loading" style="
                background: #ffffff;
                line-height: 0;
                padding: 0 0;
                text-align: center;
          ...
          <p style="
            ...
            <a href="https://www.instagram.com/p/C_6YRS3uGQx/?utm_source=ig_embed&amp;utm_campaign=loading" style="
                  ...
                  line-height: 17px;
                  text-decoration: none;
                " target="_blank">Un post condiviso da European Canoe Association
              (@canoe.europe)</a>
          </p>
        </div>
      </blockquote>
      ...
      <blockquote class="instagram-media col-6 col-md-4 m-0" style="height: 50vh; opacity: 90%" data-instgrm-captioned
        ...
        data-instgrm-version="14" style="
          ...
          ">
        <div style="padding: 16px">
          <a href="https://www.instagram.com/p/C9hojTVqXkj/?utm_source=ig_embed&amp;utm_campaign=loading" style="
                background: #ffffff;
                line-height: 0;
                padding: 0 0;
                text-align: center;
  ...
  <section class="container my-5 px-4 px-md-0" id="doveSiamo">
    <div class="mb-4">
      ...
      <p class="text-muted">
        Trova le nostre sedi e contattaci facilmente. Siamo sempre a tua
        disposizione!
      </p>
    </div>
    ...
    <div class="row g-5">
      ...
      <div class="col-12 col-md-5" data-aossssss="fade-right">
        <div class="shadow-sm p-4 rounded-3 bg-white">
          ...
          <div class="mb-4">
            <h5 class="fw-bold mb-1">Sede Legale</h5>
          ...
          <div class="mb-4">
            <h5 class="fw-bold mb-1">Sede Operativa</h5>
            <p class="text-secondary mb-0">
          ...
          <div>
            <h5 class="fw-bold mb-3">Contattaci</h5>
            <p class="mb-2">
              <i class="fas fa-phone-alt text-primary me-2"></i>
              <a href="tel:+390815703404" class="text-decoration-none text-secondary">081 570 3404</a>
              -
              <a href="tel:+390815234193" class="text-decoration-none text-secondary">081 523 4193</a>
            </p>
            <p>
              <i class="fas fa-envelope text-primary me-2"></i>
              <a href="mailto:info@3em.it" class="text-decoration-none text-secondary">info@3em.it</a>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="col-12 col-md-7" data-aossssss="fade-left">
        <div class="row g-4">
          <div class="col-12">
            <iframe class="rounded-3 shadow-sm"
              ...
              width="100%" style="border: 0; height: 250px" allowfullscreen="" loading="lazy"
              referrerpolicy="no-referrer-when-downgrade">
            </iframe>
          </div>
          <div class="col-12">
            <img src="assets/img/3EM.jpg" alt="Sede Operativa" class="rounded-3 shadow-sm w-100"
