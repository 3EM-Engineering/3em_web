...
<body>
  ...
  <section class="container px-4 px-md-auto" id="settori">
    ...
    <div class="row justify-content-start justify-content-md-center">
      ...
      <div class="col-12 col-md-8 col-xl-4 card-settori" data-aos="fade-up-right">
      ...
      <div class="col-12 col-md-8 col-xl-4 card-settori card-erection position-relative" data-aos="fade-up">
      ...
      <div class="col-12 col-md-8 col-xl-4 card-settori" data-aos="fade-up-left">
        <div class="card-body bg-black">
          <div class="card-text">
            <h2>IT Services</h2>
            <span>
  ...
  <section class="container px-4 px-md-auto mt-5" id="collaborazioni" data-aos="fade-up">
  ...
  <section class="container px-4 px-md-auto mt-5" id="sponsor" data-aos="fade-up">
  ...
  <div class="row g-5">
    ...
    <div class="col-12 col-md-5" data-aos="fade-right">
      <div class="shadow-sm p-4 rounded-3 bg-white">
        ...
        <div class="mb-4">
          ...
          <p class="text-secondary mb-0"><i class="fa-solid fa-location-dot me-2 text-primary"></i>Via A. Gramsci, 14</p>
          <p class="text-secondary">Castello di Cisterna (NA) - 80030</p>
        </div>
        <div class="mb-4">
          <h5 class="fw-bold mb-1">Sede Operativa</h5>
          <p class="text-secondary mb-0"><i class="fa-solid fa-location-dot me-2 text-primary"></i>Via Antiniana, 2/g</p>
    ...
    <div class="col-12 col-md-7" data-aos="fade-left">
      <div class="row g-4">
        ...
        <div class="col-12">
          <img src="assets/img/3EM.jpg" alt="Sede Operativa" class="rounded-3 shadow-sm w-100" style="object-fit: cover; height: 250px;">
        </div>
      </div>
    </div>
  </div>
